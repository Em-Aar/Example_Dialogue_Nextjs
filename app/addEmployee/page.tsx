...
import { postData } from "@/lib/updateEmployee";
...
export default function Page() {
  ...
  return (
    <div className="mx-auto my-6 max-w-3xl">
      <form onSubmit={handleSubmit} className="flex flex-col bg-slate-100 p-10 ">
        ...
        <button type="submit" className="bg-gray-900 text-slate-100 py-2 px-4 rounded-md">Submit</button>
      </form>
    </div>
  );
}
